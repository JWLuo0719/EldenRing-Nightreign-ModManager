...
- 保留 602 的完整 `menu_dlc01.msgbnd.dcx` 与 MMV/Weapons 文本，仅在标题页的既有页脚下追加兼容补丁署名；
...
- 页脚署名：`tools/skin-overhaul-602-zhocn-footer.json`（`CL_MenuText` 401001、401002）
...
- 产物 `menu_dlc01.msgbnd.dcx`：147,984 bytes，SHA-256
  `D19A2CEE02E0F1E11FED271FC21D093FE4949FE4470AC5DE3C2A5065DE5DF4C4`
- 回读验证：76 / 76 个 Skin Overhaul `GoodsName` ID 已写入预期名称；两个标题页状态
  （`CL_MenuText` 401001、401002）均已写入相同的兼容补丁署名。
